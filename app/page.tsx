        ...
        {isLoadingUser ? (
          ...
          <>
            <div className="sidebar-user">
              ...
              <Link href="/api/auth/logout?returnTo=/login">로그아웃</Link>
            </div>
...
const styles = `
  ...
  @media(max-width:1120px){.home-shell{grid-template-columns:82px minmax(0,1fr)}.home-sidebar{width:82px;padding:18px 12px}.home-brand div,.home-nav span,.ai-card,.sidebar-user span,.sidebar-user>a{display:none}.home-brand,.home-nav a{justify-content:center}.sidebar-user{grid-template-columns:1fr;padding:9px}.sidebar-user>b{margin:auto}.guest-view{grid-template-columns:1fr}.guest-preview{display:none}.summary-grid,.template-grid{grid-template-columns:repeat(2,1fr)}}
